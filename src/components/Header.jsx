...
import muriousLogo from "../../public/assets/muriousLogo.webp"
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a className={`block w-[12rem] xl:mr-8 ${openNavigation == true ? "relative z-3" : ""}`}  href="/">
          <img src={muriousLogo} width={50} height={25} alt="logo" />
        </a>
        ...
        <Button className="hidden lg:flex text-xl w-max" href="#login">
          Sign in
        </Button>
